...
--
-- Host: localhost    Database: bd_henry_20250714
-- ------------------------------------------------------
...
--
-- Current Database: `bd_henry_20250714`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `bd_henry_20250714` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
INSERT INTO `personas2` VALUES (1,'V',1234,'ANA','VASQUEZ','SANTA FE','av@gmail.com','1960-08-15'),(2,'E',8100,'PEDRO','ALMODOVAR','CARICUAO','pa@gmail.com','1950-09-01'),(3,'P',9100,'SARA','SUAREZ','CHACAITO','ss@hotmail.com','1990-06-20'),(4,'V',5678,'YOLANDA','TORTOZA','CATIA LA MAR','yt@gmail.com','1978-10-15'),(7,'V',9012,'NELLY','CONTRERAS','LA VEGA','nc@gmail.com','1968-07-16');
...
INSERT INTO `productos` VALUES (1,1,'NEVERA',500.25,6),(2,1,'CONGELADOR',250.75,3),(3,1,'LAVADORA 10KG',300.00,8),(4,1,'COCINA A GAS',120.00,10),(5,2,'CONGELADOR',275.00,5),(6,2,'HORNO ELECTRICO',450.00,3),(7,2,'LAVADORA 10KG',295.00,12),(8,2,'COCINA ELECTRICA',350.00,2),(9,3,'NEVERA',450.00,3),(10,3,'LAVADORA',380.00,6),(11,3,'COCINA A GAS',230.00,12),(12,3,'COCINA ELECTRICA',390.00,8),(13,4,'NEVERA',590.75,3),(14,4,'CONGELADOR',249.99,6),(15,4,'LAVADORA 10KG',310.00,3),(16,4,'COCINA A GAS',170.00,8),(18,5,'NEVERA',400.25,9);
...
INSERT INTO `productos_sin_fk` VALUES (1,1,'NEVERA',500.25,6),(2,1,'CONGELADOR',250.75,3),(3,1,'LAVADORA 10KG',300.00,8),(4,5,'COCINA A GAS',120.00,10),(5,2,'CONGELADOR',275.00,5),(6,2,'HORNO ELECTRICO',450.00,3),(7,2,'LAVADORA 10KG',295.00,12),(8,6,'COCINA ELECTRICA',350.00,2),(9,3,'NEVERA',450.00,3),(10,3,'LAVADORA',380.00,6),(11,3,'COCINA A GAS',230.00,12),(12,7,'COCINA ELECTRICA',390.00,8),(13,4,'NEVERA',590.75,3),(14,4,'CONGELADOR',249.99,6),(15,4,'LAVADORA 10KG',310.00,3),(16,8,'COCINA A GAS',170.00,8),(17,8,'',1.50,100);
...
INSERT INTO `proveedores` VALUES (1,'GENERAL ELECTRIC','AV. LECUNA','info@ge.com','0212-5431234','ANA VASQUEZ'),(2,'WHIRPOOL','AV. ROMULO GALLEGOS','info@whirpool.com','0212-9871234','YOLANDA TORTOZA'),(3,'ELECTROLUX','AV. PPAL. DE LAS MERCEDES','info@electrolux.com','0212-2671234','NELLY CONTRERAS'),(4,'LG','AV. SAN MARTIN','info@lg.com','0212-4431234','MAIBA ROMERO'),(5,'DAMASCO','AV. FCO. DE MIRANDA','info@damasco.com','0212-2431234','RORAIMA ROJAS'),(6,'HAIR','AV. PPAL. DEL VALLE','info@hair.com','0212-6431234','SOFIA CHAN'),(7,'SONY','AV. FCO. DE MIRANDA','info@sony.com','0212-2431234','SUSANA MIR'),(9,'MABE','BOLEITA NORTE','info@mabe.com','0212-7431234','NORMA GAINFA');
/*!40000 ALTER TABLE `proveedores` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `vista_prov_prod_01`
--

DROP TABLE IF EXISTS `vista_prov_prod_01`;
/*!50001 DROP VIEW IF EXISTS `vista_prov_prod_01`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vista_prov_prod_01` AS SELECT
 1 AS `proveedor`,
  1 AS `contacto`,
  1 AS `telefono`,
  1 AS `producto`,
...
--
-- Temporary table structure for view `vista_prov_prod_02`
--

DROP TABLE IF EXISTS `vista_prov_prod_02`;
/*!50001 DROP VIEW IF EXISTS `vista_prov_prod_02`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vista_prov_prod_02` AS SELECT
 1 AS `proveedor`,
  1 AS `direccion`,
...
--
-- Temporary table structure for view `vista_prov_prod_null`
--

DROP TABLE IF EXISTS `vista_prov_prod_null`;
/*!50001 DROP VIEW IF EXISTS `vista_prov_prod_null`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vista_prov_prod_null` AS SELECT
 1 AS `proveedor`,
  1 AS `contacto`,
  1 AS `telefono`,
  1 AS `producto`,
...
--
-- Final view structure for view `vista_prov_prod_01`
--
...
/*!50001 VIEW `vista_prov_prod_01` AS select `a`.`nombre` AS `proveedor`,`a`.`persona_contacto` AS `contacto`,`a`.`telefono` AS `telefono`,`b`.`nombre` AS `producto`,`b`.`precio` AS `precio` from (`proveedores` `a` join `productos` `b` on(`b`.`proveedor_id` = `a`.`id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_prov_prod_02`
--
...
-- Dump completed on 2025-07-17 11:14:39
