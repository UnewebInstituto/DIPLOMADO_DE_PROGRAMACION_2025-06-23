-- Creación de campos del tipo arreglos
...
-- 1ra. Forma de ingresar datos en un campo del tipo arreglo
insert into contactos2(nombre, apellido, fecha_nacimiento, direccion, telefono, correo_electronico) values 
('ANA'    ,'VASQUEZ'  ,'1960-08-15','SANTA FE'    ,'{"0414-1234567","0212-9998877"}','av@gmail.com'),
('PEDRO'  ,'ALMODOVAR','1950-09-01','CARICUAO'    ,'{"0424-9876543","0212-5556644","0412-1234567"}','pa@gmail.com'),
('SARA'   ,'SUAREZ'   ,'1990-06-20','CHACAITO'    ,'{"0212-6782345"}','ss@hotmail.com'),
('YOLANDA','TORTOZA'  ,'1978-10-15','CATIA LA MAR','{"0412-9996543","0212-4563728"}','yt@gmail.com');

-- 2da. Forma de ingresar datos en un campo del tipo arreglo
insert into contactos2(nombre, apellido, fecha_nacimiento, direccion, telefono, correo_electronico) values 
('MARLENE','FERNANDES','1976-09-20','AV. LECUNA',ARRAY['0212-9871234','0414-6542323'],'mf@gmail.com'),
('LIBIA','COLS','1980-11-15','GUARENAS',ARRAY['0212-3631234','0412-8765432','0414-7871234'],'lc@gmail.com');

-- OPERACIONES DE CRUD, SON ESTANDAR SQL
...
SELECT nombre as "Nombre", apellido as "Apellido", 
       ...
       telefono[2] as "Teléfono ofi.",
       telefono[3] as "Teléfono cel.",
...
-- Otra forma de declaración de proveedores
create table proveedores(
