...
COPY public.imagenes (id, producto_id, imagen) FROM stdin;
\.
...
COPY public.productos (id, categoria_id, nombre, precio, existencia, desripcion) FROM stdin;
\.
...
1	ANA	VASQUEZ	{av@gmail.com,av@hotmail.com}	{041287594975,042487353454}
2	PEDRO	ALMODOVAR	{pa@gmail.com,pa@hotmail.com}	{0412346758739,04140986779,0412876947333}
3	SARA	SUAREZ	{ss@hotmail.com,ss@gmail.com}	{04267866559}
4	YOLANDA	TORTOZA	{yt@gmail.com,yt@hotmail.com}	{041454773639,041608857234}
\.
...
--
-- Name: usuarios_roles rol_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: usuarios_roles usuario_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
